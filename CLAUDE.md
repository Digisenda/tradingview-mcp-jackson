...
`D:\Projects\TRADINGVIEW\.claude\skills\checklist-premarket\SKILL.md`. Este archivo (CLAUDE.md
del fork) describe solo las herramientas MCP y sus límites reales; los workflows de varios pasos
que las consumen viven como skills en el repo de trabajo diario (`TRADINGVIEW`), sin importar que
usen herramientas de este servidor — el MCP `tradingview` está registrado globalmente, no depende
de la carpeta desde la que se abre Claude Code.
